...
public class UserResponseDTO {
    ...
    @java.lang.SuppressWarnings("all")
    public void setCertificationCount(final Integer certificationCount) {
    ...
    public java.lang.String toString() {
        return "UserResponseDTO(id=" + this.getId() + ", firstName=" + this.getFirstName() + ", middleName=" + this.getMiddleName() + ", lastName=" + this.getLastName() + ", email=" + this.getEmail() + ", role=" + this.getRole() + ", age=" + this.getAge() + ", gender=" + this.getGender() + ", country=" + this.getCountry() + ", studentId=" + this.getStudentId() + ")";
    }
}
